    ...
    <div className="flex-center" style={{ minHeight: '100vh' }}>
      <Card style={{ width: '100%', maxWidth: '500px', textAlign: 'center' }}>
        ...
        <div style={{ marginTop: '40px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
          <Input placeholder="البريد الإلكتروني" style={{ fontSize: '20px', padding: '16px' }} />
          
          <div style={{ display: 'flex', gap: '16px' }}>
            <Button style={{ flex: 1 }} onClick={() => navigate('/register/step2')}>التالي</Button>
            <Button variant="outline" style={{ flex: 1 }} onClick={() => navigate('/login')}>السابق</Button>
          </div>
        </div>
      </Card>
    </div>
